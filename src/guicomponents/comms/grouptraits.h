...
class COMMS_EXPORT GroupTraits: public BaseGroupTraits {
 public:
  COMPONENT_ID(BaseGroupTraits, GroupTraits);
  GroupTraits(Entity* entity);
  virtual ~GroupTraits();

  virtual GroupType get_group_type() const {return GroupType::DataGroup;}
