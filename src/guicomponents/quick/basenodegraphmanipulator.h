...
class BaseNodeGraphManipulator: public Component {
 public:
  ...
  virtual bool is_waiting_for_response() = 0;
  virtual void force_stack_reset() = 0;
  ...
  // Group logic..
  virtual void enter_group_prep(Entity* group) = 0;
  virtual void exit_group_prep(Entity* group) = 0;
