...
CMAKE_BUILD_ROOT=/d/android_release
rm -fr $CMAKE_BUILD_ROOT
mkdir -p $CMAKE_BUILD_ROOT
cd $CMAKE_BUILD_ROOT

# create our ninja files
cmake -G "Ninja" -DCMAKE_TOOLCHAIN_FILE=/d/src/ngsinternal/src/toolchain_android.cmake -DCMAKE_BUILD_TYPE=Release /d/src/ngsinternal/src;
