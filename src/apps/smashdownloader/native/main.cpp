...
int main(int argc, char *argv[]) {
  ...
  bootstrap_memory_tracker();
  {
    ...
    QApplication::setApplicationName("SmashDownloader"); // This affects the user's data dir resolution.
    QApplication::setOrganizationDomain("smashdownloader.com");

    // Check to make sure that there are no other instance running.
    bool first_instance = true;

    QString tmpDir = QDir::tempPath();
    QLockFile lockFile(tmpDir + "/smashdownloader.lock");
