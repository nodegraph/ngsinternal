...
BaseStackPage{
    ...
    function on_add_element() {
        ...
        if (value_type == GUITypes.Object) {
            var push_page = app_loader.load_component("qrc:///qml/youmacro/contentpages/enterdatapages/EnterStringAndDropdownPage.qml", stack_page, {})
        	...
        	if (hints.hasOwnProperty(GUITypes.ElementJSTypeHint)) {
        		var push_page = app_loader.load_component("qrc:///qml/youmacro/contentpages/enterdatapages/EnterNumberPage.qml", stack_page, {})
            	push_page.visible = true
        		...
        		var push_page = app_loader.load_component("qrc:///qml/youmacro/contentpages/enterdatapages/EnterNumberAndDropdownPage.qml", stack_page, {})
            	push_page.visible = true
            	push_page.set_value(0)
            	push_page.set_bottom_value(0)
            	push_page.set_top_value(value.length)
    ...
    function on_edit_element(name) {
        ...
        case GUITypes.String:
        	if (child_hints.hasOwnProperty(GUITypes.MultiLineHint)) {
        		var page = app_loader.load_component("qrc:///qml/youmacro/contentpages/editdatapages/EditMultiLinePage.qml", edit_data_list_stack_page, {})
        		...
        		var page = app_loader.load_component("qrc:///qml/youmacro/contentpages/editdatapages/EditPasswordPage.qml", edit_data_list_stack_page, {})
	            setup_edit_page(page, name, child_value, child_hints, exposed)
	            stack_view.push_page(page)
        	} else {
	            var page = app_loader.load_component("qrc:///qml/youmacro/contentpages/editdatapages/EditLinePage.qml", edit_data_list_stack_page, {})
	            setup_edit_page(page, name, child_value, child_hints, exposed)
	            stack_view.push_page(page)
            }
            break
        case GUITypes.Boolean:
            var page = app_loader.load_component("qrc:///qml/youmacro/contentpages/editdatapages/EditBooleanPage.qml", edit_data_list_stack_page, {})
            setup_edit_page(page, name, child_value, child_hints, exposed)
            stack_view.push_page(page)
            break
        case GUITypes.Number:
            if (child_hints.hasOwnProperty(GUITypes.EnumHint)) {
                var page = app_loader.load_component("qrc:///qml/youmacro/contentpages/editdatapages/EditEnumPage.qml", edit_data_list_stack_page, {})
                setup_edit_page(page, name, child_value, child_hints, exposed)
                stack_view.push_page(page)
            } else {
                var page = app_loader.load_component("qrc:///qml/youmacro/contentpages/editdatapages/EditNumberPage.qml", edit_data_list_stack_page, {})
                setup_edit_page(page, name, child_value, child_hints, exposed)
                stack_view.push_page(page)
            }
            break
