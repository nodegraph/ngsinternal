...
create_installer ()
{
	...
	"C:/Program Files (x86)/Windows Kits/8.1/bin/x64/signtool.exe" sign //debug //tr http:////timestamp.digicert.com //td sha256 //fd sha256 //f "c:\shingo\critical\code_sign_certs\my_cert.pfx" //p ${PASSWORD} "${PACK}/${installer_base_name}.exe"
}
