...
ListModel {
    ...
    ListElement {
        ...
        script: "node_graph_page.node_graph.create_group_node(center_new_nodes); menu_stack_page.visible = false"
    }
    ListElement {
        ...
        script: "node_graph_page.node_graph.create_input_node(center_new_nodes); menu_stack_page.visible = false"
    }
    ListElement {
        ...
        script: "node_graph_page.node_graph.create_output_node(center_new_nodes); menu_stack_page.visible = false"
    }
    ListElement {
        ...
        script: "node_graph_page.node_graph.create_dot_node(center_new_nodes); menu_stack_page.visible = false"
    }
    ListElement {
