...
import todopile.actionbars 1.0
import todopile.pages 1.0
import todopile.dialogs 1.0
import todopile.menus 1.0
import todopile.tools 1.0
import todopile.apis 1.0
import todopile.config 1.0
...
//    }
    ...
    function load_components() {
        ...
        load_component("web_browser_page", "todopile/pages/WebBrowserPage.qml",
                                          app_window, {
                                              "visible": false
                                          })

        load_component("posts_page","todopile/pages/PostsPage.qml",
                                    app_window, {
                                        "visible": false
                                    })
        load_component("settings_page","todopile/pages/SettingsPage.qml",
                                    app_window, {
                                        "visible": false
                                    })
        load_component("edit_node_page","todopile/pages/EditNodePage.qml",
                                    app_window, {
                                        "visible": false
                                    })
        load_component("view_node_page","todopile/pages/ViewNodePage.qml",
                                    app_window, {
                                        "visible": false
                                    })
        load_component("url_entry_page","todopile/pages/UrlEntryPage.qml",
                                    app_window, {
                                        "visible": false
                                    })
        load_component("empty_page","todopile/pages/EmptyPage.qml",
                                    app_window, {
                                        "visible": false
                                    })

        // Our Action Bars.
        load_component("main_bar","todopile/actionbars/MainBar.qml", app_window, {})
        load_component("copy_paste_bar","todopile/actionbars/CopyPasteBar.qml",
                                        app_window, {
                                            "visible": false,
                                            z: app_settings.copy_paste_bar_z
                                        })
        load_component("splitter","todopile/actionbars/Splitter.qml",
                                  app_window, {"visible": false})

        // Our Menus.
        load_component("web_browser_menu","todopile/menus/WebBrowserMenu.qml",
                                  app_window, {"visible": false})
        load_component("node_graph_menu","todopile/menus/NodeGraphMenu.qml",
                                  app_window, {"visible": false})
        load_component("node_menu","todopile/menus/NodeMenu.qml",
                                  app_window, {"visible": false})
        load_component("group_node_menu","todopile/menus/GroupNodeMenu.qml",
                                  app_window, {"visible": false})
        load_component("view_node_menu","todopile/menus/ViewNodeMenu.qml",
                                  app_window, {"visible": false})

//        // Our Dialogs.
        load_component("message_dialog","todopile/dialogs/MessageDialog.qml",
                                        app_window, {"visible": false})
//        load_component("choose_file_dialog","todopile/dialogs/ChooseFileDialog.qml",
//                                        app_window, {"visible": false})
        load_component("url_dialog","todopile/dialogs/UrlDialog.qml",
                                        app_window, {"visible": false})
        load_component("node_name_dialog","todopile/dialogs/NodeNameDialog.qml",
                                        app_window, {"visible": false})

        // Our App Tools.
        // This always draws on top of everything else.
        load_component("app_tooltip","todopile/tools/AppTooltip.qml",
                                    app_window, {"z": app_settings.app_tooltip_z, "visible": false})

        // Our App Apis.
        load_component("node_pool_api","todopile/apis/NodePoolAPI.qml",
                                    app_window, {"visible": false})
                                    
        load_component("node_graph_page","todopile/pages/NodeGraphPage.qml",
                    app_window, {
                        "visible": false
                   })
    ...
    function load_components2() {
        ...
        load_component2("web_browser_page", "todopile/pages/WebBrowserPage.qml",
                                          app_window, {
                                              "visible": false
                                          })
        load_component2("node_graph_page","todopile/pages/NodeGraphPage.qml",
                                         app_window, {
                                             "visible": false,
                                             "z": 100
                                         })
        load_component2("posts_page","todopile/pages/PostsPage.qml",
                                    app_window, {
                                        "visible": false
                                    })
        load_component2("settings_page","todopile/pages/SettingsPage.qml",
                                    app_window, {
                                        "visible": false
                                    })
        load_component2("edit_node_page","todopile/pages/EditNodePage.qml",
                                    app_window, {
                                        "visible": false
                                    })
        load_component2("view_node_page","todopile/pages/ViewNodePage.qml",
                                    app_window, {
                                        "visible": false
                                    })
        load_component2("url_entry_page","todopile/pages/UrlEntryPage.qml",
                                    app_window, {
                                        "visible": false
                                    })
        load_component2("empty_page","todopile/pages/EmptyPage.qml",
                                    app_window, {
                                        "visible": false
                                    })

        // Our Action Bars.
        load_component2("main_bar","todopile/actionbars/MainBar.qml", app_window, {})
        load_component2("copy_paste_bar","todopile/actionbars/CopyPasteBar.qml",
                                        app_window, {
                                            "visible": false,
                                            z: app_settings.copy_paste_bar_z
                                        })
        load_component2("splitter","todopile/actionbars/Splitter.qml",
                                  app_window, {"visible": false})

        // Our Menus.
        load_component2("web_browser_menu","todopile/menus/WebBrowserMenu.qml",
                                  app_window, {"visible": false})
        load_component2("node_graph_menu","todopile/menus/NodeGraphMenu.qml",
                                  app_window, {"visible": false})
        load_component2("node_menu","todopile/menus/NodeMenu.qml",
                                  app_window, {"visible": false})
        load_component2("group_node_menu","todopile/menus/GroupNodeMenu.qml",
                                  app_window, {"visible": false})
        load_component2("view_node_menu","todopile/menus/ViewNodeMenu.qml",
                                  app_window, {"visible": false})

//        // Our Dialogs.
        load_component2("message_dialog","todopile/dialogs/MessageDialog.qml",
                                        app_window, {"visible": false})
//        load_component2("choose_file_dialog","todopile/dialogs/ChooseFileDialog.qml",
//                                        app_window, {"visible": false})
        load_component2("url_dialog","todopile/dialogs/UrlDialog.qml",
                                        app_window, {"visible": false})
        load_component2("node_name_dialog","todopile/dialogs/NodeNameDialog.qml",
                                        app_window, {"visible": false})

        // Our App Tools.
        // This always draws on top of everything else.
        load_component2("app_tooltip","todopile/tools/AppTooltip.qml",
                                    app_window, {"z": app_settings.app_tooltip_z, "visible": false})

        // Our App Apis.
        load_component2("node_pool_api","todopile/apis/NodePoolAPI.qml",
                                    app_window, {"visible": false})
    }
