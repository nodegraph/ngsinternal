...
set(QML_ROOT_PATH ${CMAKE_SOURCE_DIR}/apps/todopile/qml)
set(APPLICATION_BINARY ${CMAKE_BINARY_DIR}/install_todopile/libs/armeabi-v7a/libtodopile.so)
set(ANDROID_PACKAGE_SOURCE_DIRECTORY ${CMAKE_BINARY_DIR}/install_todopile_overrides)

# Make our main install_todopile output dir.
file(MAKE_DIRECTORY ${CMAKE_BINARY_DIR}/install_todopile/libs/armeabi-v7a)

# Make our install_todopile overrides dir.
file(MAKE_DIRECTORY ${CMAKE_BINARY_DIR}/install_todopile_overrides)
...
add_custom_command (
  DEPENDS install
  OUTPUT prep_todopile_cmd
  # copy the installed libs into the install_todopile/libs/armeabi-v7a folder
  COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_BINARY_DIR}/install/lib ${CMAKE_BINARY_DIR}/install_todopile/libs/armeabi-v7a
  # copy the gdb server file over
  COMMAND ${CMAKE_COMMAND} -E copy ${ANDROID_NDK_ROOT}/prebuilt/android-arm/gdbserver/gdbserver ${CMAKE_BINARY_DIR}/install_todopile/libs/armeabi-v7a
  # rename gdbserver to gdbserver.so
  COMMAND ${CMAKE_COMMAND} -E rename ${CMAKE_BINARY_DIR}/install_todopile/libs/armeabi-v7a/gdbserver ${CMAKE_BINARY_DIR}/install_todopile/libs/armeabi-v7a/gdbserver.so
  COMMAND ${CMAKE_COMMAND} -E remove ${CMAKE_BINARY_DIR}/install_todopile/libs/armeabi-v7a/gdbserver
...
add_custom_target (prep_todopile
   DEPENDS prep_todopile_cmd
)
