    ...
    handle_menu_click(menu_event: MouseEvent): void {
        ...
        if (this.context_menu.navigate_to_url.contains(menu_target)) {
            function goto_url(url: string) {
                let req = new RequestMessage(RequestType.kNavigateTo)
                req.args = {url: url}
            ...
            let req = new RequestMessage(RequestType.kGetAllCookies)
            this.content_comm.send_to_bg(req)
        }

        else if (this.context_menu.test3.contains(menu_target)) {
            let req = new RequestMessage(RequestType.kClearAllCookies)
            this.content_comm.send_to_bg(req)
        }

        else if (this.context_menu.test4.contains(menu_target)) {
            let req = new RequestMessage(RequestType.kSetAllCookies)
            req.args = {
            ...
            let req = new RequestMessage(RequestType.kGetZoom)
            this.content_comm.send_to_bg(req)
        }
        ...
        //    } 
            ...
            let req = new RequestMessage(RequestType.kNavigateRefresh)
            this.content_comm.send_to_bg(req)
        }
        ...
        // Create set from text values.
            ...
            let req = new RequestMessage(RequestType.kCreateSetFromMatchValues)
            req.args = {
        ...
        // Find all inputs.
            ...
            let req = new RequestMessage(RequestType.kCreateSetFromWrapType)
            req.args = {
        ...
        // Delete set.
            ...
            let req = new RequestMessage(RequestType.kDeleteSet)
        ...
        // Text.
            ...
            let set_index = this.overlay_sets.find_set_index(this.context_menu.get_page_pos())
            let req = new RequestMessage(RequestType.kShiftSet)
            req.args = {
                set_index: set_index,
        ...
        // Expand above.
            ...
            let req = new RequestMessage(RequestType.kExpandSet)
            req.args = {
                set_index: set_index,
                direction: Direction.up,
        ...
        // Mark set.
            ...
            let set_index = this.overlay_sets.find_set_index(this.context_menu.get_page_pos())
            let req = new RequestMessage(RequestType.kMarkSet)
            req.args = {
                set_index: set_index
            }
            this.content_comm.send_to_bg(req)
        ...
        // Unmark set.
            ...
            let set_index = this.overlay_sets.find_set_index(this.context_menu.get_page_pos())
            let req = new RequestMessage(RequestType.kUnmarkSet)
            req.args = {
                set_index: set_index
            }
            this.content_comm.send_to_bg(req)
        ...
        // Merge marked sets.
            ...
            let req = new RequestMessage(RequestType.kMergeMarkedSets)
            this.content_comm.send_to_bg(req)
        }
            ...
            let req = new RequestMessage(RequestType.kShrinkSetToMarked)
            req.args = {
                set_index: set_index,
        ...
        // ----------------------------------------------------------
            ...
            let set_index = this.overlay_sets.find_set_index(this.context_menu.get_page_pos())
            let req = new RequestMessage(RequestType.kShrinkSet)
            req.args = {
                set_index: set_index,
                direction: Direction.up
            }
        ...
        // ----------------------------------------------------------
            ...
            let set_index = this.overlay_sets.find_set_index(this.context_menu.get_page_pos())
            if (set_index >= 0) {
                let req = new RequestMessage(RequestType.kPerformAction)
                req.args = {
                    set_index: set_index,
                    overlay_index: 0,
