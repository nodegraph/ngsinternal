...
AppStackPage{
    ...
    function init() {
        ...
        var page = app_loader.load_component("qrc:///qml/smashbrowse/stackedpages/FilePage.qml", file_stack_page, {})
        page.visible = true
    ...
    function on_open_file_options() {
        stack_view.push_by_names(get_file_page().get_current_setting('title'), "NodeActionPage", "FileActions")
    }
    ...
    function on_create_file_page() {
        var page = app_loader.load_component("qrc:///qml/smashbrowse/stackedpages/CreateFilePage.qml", file_stack_page, {})
        page.visible = true
