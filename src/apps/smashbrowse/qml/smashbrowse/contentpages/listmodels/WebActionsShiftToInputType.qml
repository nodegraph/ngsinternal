...
ListModel {
    ...
    ListElement {
        ...
        title: "Above"
        description: "Shift to input field elements above."
    ...
    ListElement {
        ...
        title: "Below"
        description: "Shift to input field elements below."
    ...
    ListElement {
        image_url: "qrc:///icons/ic_settings_system_daydream_white_48dp.png"
        title: "On Left"
        description: "Shift to input field elements on left."
    ...
    ListElement {
        image_url: "qrc:///icons/ic_mode_edit_white_48dp.png"
        title: "On Right"
        description: "Shift to input field elements on right."
