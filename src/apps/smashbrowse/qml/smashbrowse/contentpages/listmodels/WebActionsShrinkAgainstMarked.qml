...
ListModel {
    ...
    ListElement {
        ...
        script: "web_recorder.record_shrink_above_of_marked();
    ...
    ListElement {
        ...
        script: "web_recorder.record_shrink_below_of_marked();
        		main_bar.switch_to_current_mode();"
    }
    ...
    ListElement {
        ...
        script: "web_recorder.record_shrink_above_and_below_of_marked();
        		main_bar.switch_to_current_mode();"
    }
    ...
    ListElement {
        ...
        script: "web_recorder.record_shrink_left_of_marked();
        		main_bar.switch_to_current_mode();"
    }
    ...
    ListElement {
        ...
        script: "web_recorder.record_shrink_right_of_marked();
        		main_bar.switch_to_current_mode();"
    }
    ...
    ListElement {
        ...
        script: "web_recorder.record_shrink_left_and_right_of_marked();
        		main_bar.switch_to_current_mode();"
    }
