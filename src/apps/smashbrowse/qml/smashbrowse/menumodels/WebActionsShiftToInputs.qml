...
ListModel {
    ...
    ListElement {
        ...
        script: "app_worker.shift_to_inputs_above()"
    }
    ...
    ListElement {
        ...
        script: "app_worker.shift_to_inputs_below()"
    }
    ...
    ListElement {
        ...
        script: "app_worker.shift_to_inputs_on_left()"
    }
    ...
    ListElement {
        ...
        script: "app_worker.shift_to_inputs_on_right()"
    }
