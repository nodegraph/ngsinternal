...
ListModel {
    ...
    ListElement {
        ...
        script: "app_worker.record_shift_to_inputs_above()"
    }
    ...
    ListElement {
        ...
        script: "app_worker.record_shift_to_inputs_below()"
    }
    ...
    ListElement {
        ...
        script: "app_worker.record_shift_to_inputs_on_left()"
    }
    ...
    ListElement {
        ...
        script: "app_worker.record_shift_to_inputs_on_right()"
    }
