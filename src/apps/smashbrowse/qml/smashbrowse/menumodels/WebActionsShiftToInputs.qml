...
ListModel {
    ...
    ListElement {
        ...
        script: "app_comm.shift_to_inputs_above();
    ...
    ListElement {
        ...
        script: "app_comm.shift_to_inputs_below();
                 main_bar.switch_to_current_mode();"
    }
    ...
    ListElement {
        ...
        script: "app_comm.shift_to_inputs_on_left();
                 main_bar.switch_to_current_mode();"
    }
    ...
    ListElement {
        ...
        script: "app_comm.shift_to_inputs_on_right();
                 main_bar.switch_to_current_mode();"
    }
