...
ListModel {
    ...
    ListElement {
        ...
        script: "app_worker.record_create_set_of_images()"
    }
    ...
    ListElement {
        ...
        script: "app_worker.record_create_set_of_text()"
    }
    ...
    ListElement {
        ...
        script: "app_worker.record_create_set_of_inputs()"
    }
    ...
    ListElement {
        ...
        script: "app_worker.record_create_set_of_selects()"
    }
