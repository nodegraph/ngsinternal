...
ListModel {
    ...
    ListElement {
        ...
        script: "file_menu_stack_page.on_create_file_info();"
    }
    ...
    ListElement {
        ...
        script: "file_menu_stack_page.on_open_file_list();"
    }
    ...
    ListElement {
        ...
        script: "file_menu_stack_page.on_save_current()"
    }
    ...
    ListElement {
        ...
        script: "file_menu_stack_page.on_destroy_current();"
    }
