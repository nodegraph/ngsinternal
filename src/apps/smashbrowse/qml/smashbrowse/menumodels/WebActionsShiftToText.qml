...
ListModel {
    ...
    ListElement {
        ...
        script: "app_worker.shift_to_text_above()"
    }
    ...
    ListElement {
        ...
        script: "app_worker.shift_to_text_below()"
    }
    ...
    ListElement {
        ...
        script: "app_worker.shift_to_text_on_left()"
    }
    ...
    ListElement {
        ...
        script: "app_worker.shift_to_text_on_right()"
    }
