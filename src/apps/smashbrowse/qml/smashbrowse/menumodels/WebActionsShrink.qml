...
ListModel {
    ...
    ListElement {
        ...
        script: "app_comm.shrink_set_to_topmost()"
    }
    ...
    ListElement {
        ...
        script: "app_comm.shrink_set_to_bottommost()"
    }
    ...
    ListElement {
        ...
        script: "app_comm.shrink_set_to_leftmost()"
    }
    ...
    ListElement {
        ...
        script: "app_comm.shrink_set_to_rightmost()"
    }
