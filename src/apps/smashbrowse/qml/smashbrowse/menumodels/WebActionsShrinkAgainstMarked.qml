...
ListModel {
    ...
    ListElement {
        ...
        script: "app_recorder.record_shrink_above_of_marked()"
    }
    ...
    ListElement {
        ...
        script: "app_recorder.record_shrink_below_of_marked()"
    }
    ...
    ListElement {
        ...
        script: "app_recorder.record_shrink_above_and_below_of_marked()"
    }
    ...
    ListElement {
        ...
        script: "app_recorder.record_shrink_left_of_marked()"
    }
    ...
    ListElement {
        ...
        script: "app_recorder.record_shrink_right_of_marked()"
    }
    ...
    ListElement {
        ...
        script: "app_recorder.record_shrink_left_and_right_of_marked()"
    }
