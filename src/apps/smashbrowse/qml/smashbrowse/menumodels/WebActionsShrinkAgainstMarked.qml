...
ListModel {
    ...
    ListElement {
        ...
        script: "app_comm.shrink_above_of_marked()"
    }
    ...
    ListElement {
        ...
        script: "app_comm.shrink_below_of_marked()"
    }
    ...
    ListElement {
        ...
        script: "app_comm.shrink_above_and_below_of_marked()"
    }
    ...
    ListElement {
        ...
        script: "app_comm.shrink_left_of_marked()"
    }
    ...
    ListElement {
        ...
        script: "app_comm.shrink_right_of_marked()"
    }
    ...
    ListElement {
        ...
        script: "app_comm.shrink_left_and_right_of_marked()"
    }
