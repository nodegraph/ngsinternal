...
BaseStackPage{
    ...
    function on_publish_public_macro() {
    	var push_page = app_loader.load_component("qrc:///qml/robodownloader/contentpages/enterdatapages/PublishMacroPage.qml", page, {})
    ...
    function on_open_file_list() {
        var push_page = app_loader.load_component("qrc:///qml/robodownloader/contentpages/listpages/FileListPage.qml", page, {})
        push_page.init()
        push_page.visible = true
        stack_view.push_page(push_page)
    }
    ...
    function on_create_file_info() {
        var push_page = app_loader.load_component("qrc:///qml/robodownloader/contentpages/enterdatapages/CreateFilePage.qml", page, {})
        push_page.visible = true
