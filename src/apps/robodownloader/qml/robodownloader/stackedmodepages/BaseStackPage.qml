...
Rectangle{
    ...
    function show_busy_page() {
    	if (is_busy()) {
	        ...
	        var push_page = app_loader.load_component("qrc:///qml/robodownloader/contentpages/warningpages/ProcessingPage.qml", ng_menu_list_stack_page, {})
    ...
    function on_action_ignored() {
        var push_page = app_loader.load_component("qrc:///qml/robodownloader/contentpages/warningpages/IgnoredActionPage.qml", edit_data_list_stack_page, {})
        push_page.visible = true
